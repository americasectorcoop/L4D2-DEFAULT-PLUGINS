...
Menu DisplayRotateMenu(int client)
{
  ...
  menu.AddItem("rotate1x", "Rotate 1� (X axys)");
  menu.AddItem("rotate10x", "Rotate 10� (X axys)");
  menu.AddItem("rotate15x", "Rotate 15� (X axys)");
  menu.AddItem("rotate45x", "Rotate 45� (X axys)");
  menu.AddItem("rotate90x", "Rotate 90� (X axys)");
  menu.AddItem("rotate180x", "Rotate 180� (X axys)");
  menu.AddItem("rotate1y", "Rotate 1� (Y axys)");
  menu.AddItem("rotate10y", "Rotate 10� (Y axys)");
  menu.AddItem("rotate15y", "Rotate 15� (Y axys)");
  menu.AddItem("rotate45y", "Rotate 45� (Y axys)");
  menu.AddItem("rotate90y", "Rotate 90� (Y axys)");
  menu.AddItem("rotate180y", "Rotate 180� (Y axys)");
  menu.AddItem("rotate1z", "Rotate 1� (Z axys)");
  menu.AddItem("rotate10z", "Rotate 10� (Z axys)");
  menu.AddItem("rotate15z", "Rotate 15� (Z axys)");
  menu.AddItem("rotate45z", "Rotate 45� (Z axys)");
  menu.AddItem("rotate90z", "Rotate 90� (Z axys)");
  menu.AddItem("rotate180z", "Rotate 180� (Z axys)");
